...
bash -lc "export PATH=$PATH:$PREFIX/Library/bin && autoreconf -fi && ./configure --enable-python-integration --prefix=`cygpath -u $PREFIX` PYTHON=`which python` && make || make && make install"
